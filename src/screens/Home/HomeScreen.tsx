...
const HomeScreen: React.FC<HomeScreenProps> = ({ navigation }) => {
  ...
  const renderTerminalHeader = () => (
    <View style={styles.headerContainer}>
      ...
      <TouchableOpacity style={styles.alarmButton} onPress={() => console.log('Alarm pressed')}>
        <BellIcon />
      </TouchableOpacity>
  ...
  const getNavButtonStyle = (tab: string) => {
    switch (tab) {
      case 'Home':
        return styles.homeButton;
      case 'Practice':
        return styles.practiceButton;
      case 'Community':
        return styles.communityButton;
      case 'Profile':
        return styles.profileButton;
      default:
        return styles.homeButton;
    }
  };
